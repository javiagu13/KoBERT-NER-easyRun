...
### If you want any other model, try loading it, in case of error, do same as with kobert (local loading)
MODEL_PATH_MAP = {
    'kobert': './kobert', ### This was changed to local loading due to issues with huggingface
